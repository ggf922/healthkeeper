...
const translations = {
    ko: {
        ...
        'column-viewall': '건강 정보 34편 전체 보기 →',
        'hero-blog-link': '📚 전문가가 정리한 건강 정보 34편 보러가기 →',
    ...
    en: {
        ...
        'camera-feature-more': 'Learn the science →',
        ...
        'column-viewall': 'View all 34 health articles →',
        'hero-blog-link': '📚 Read 34 expert health articles →',
    ...
    zh: {
        ...
        'column-viewall': '查看全部34篇健康信息 →',
        'hero-blog-link': '📚 阅读专家整理的34篇健康信息 →',
        'combo-title': '🤝 推荐营养品搭配',
    ...
    ja: {
        ...
        'column-viewall': '健康情報全３４編を見る →',
        'hero-blog-link': '📚 専門家がまとめた健康情報３４編を見る →',
        ...
        'footer-link-about': 'サービス紹介',
        'footer-link-blog': '健康情報',
    ...
    es: {
        ...
        'camera-feature-more': 'Descubre la ciencia →',
        ...
        'column-viewall': 'Ver los 34 artículos de salud →',
        'hero-blog-link': '📚 Lee 34 artículos de salud de expertos →',
    ...
    fr: {
        ...
        'camera-feature-more': 'Comprendre la science →',
        ...
        'column-viewall': 'Voir les 34 articles santé →',
        'hero-blog-link': '📚 Lire 34 articles santé d\u2019experts →',
    ...
    ru: {
        ...
        'camera-feature-more': 'Узнать принцип →',
        ...
        'column-viewall': 'Смотреть все 34 статей о здоровье →',
        'hero-blog-link': '📚 34 экспертных статей о здоровье →',
    ...
    ar: {
        ...
        'camera-feature-more': 'تعرّف على المبدأ العلمي ←',
        ...
        'column-viewall': 'عرض جميع مقالات الصحة الـ 34 →',
        'hero-blog-link': '📚 اقرأ 34 مقالة صحية من الخبراء →',
