...
const translations = {
    ko: {
        ...
        'column-viewall': '건강 정보 30편 전체 보기 →',
        'hero-blog-link': '📚 전문가가 정리한 건강 정보 30편 보러가기 →',
    ...
    en: {
        ...
        'column-viewall': 'View all 30 health articles →',
        'hero-blog-link': '📚 Read 30 expert health articles →',
    ...
    zh: {
        ...
        'column-viewall': '查看全部30篇健康信息 →',
        'hero-blog-link': '📚 阅读专家整理的30篇健康信息 →',
        'combo-title': '🤝 推荐营养品搭配',
    ...
    ja: {
        ...
        'column-viewall': '健康情報全３０編を見る →',
        'hero-blog-link': '📚 専門家がまとめた健康情報３０編を見る →',
    ...
    es: {
        ...
        'column-viewall': 'Ver los 30 artículos de salud →',
        'hero-blog-link': '📚 Lee 30 artículos de salud de expertos →',
    ...
    fr: {
        ...
        'column-viewall': 'Voir les 30 articles santé →',
        'hero-blog-link': '📚 Lire 30 articles santé d\u2019experts →',
    ...
    ru: {
        ...
        'column-viewall': 'Смотреть все 30 статей о здоровье →',
        'hero-blog-link': '📚 30 экспертных статей о здоровье →',
    ...
    ar: {
        ...
        'column-viewall': 'عرض جميع مقالات الصحة الـ 30 →',
        'hero-blog-link': '📚 اقرأ 30 مقالة صحية من الخبراء →',
